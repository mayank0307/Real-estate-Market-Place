...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "owner cannot approve own address");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "message sender needs to be the owner of the contract or approve for all needs to be enabled"); 
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "source address must be the owner of the token");
...
contract MikeRealERC721Token is ERC721Metadata("Mike Real Token", "SRT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
